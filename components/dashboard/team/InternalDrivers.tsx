...
import { TeamDriver } from '@/lib/mock/teamDashboardData';

interface InternalDriversProps {
    drivers: TeamDriver[];
    selectedId?: string;
...
export function InternalDrivers({ drivers, selectedId, onSelect, isCompact }: InternalDriversProps) {
    return (
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center justify-between w-full">
                                ...
                                {/* Influence Direction - Fades out in compact */}
                                <span className={cn(
                                    "px-0 py-0 text-xs font-mono uppercase tracking-widest transition-opacity duration-300",
                                    driver.influence === 'Negative' ? "text-strain" :
                                        driver.influence === 'Neutral' ? "text-withdrawal" :
                                            "text-engagement",
