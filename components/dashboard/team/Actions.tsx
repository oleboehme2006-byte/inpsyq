...
import { TeamAction } from '@/lib/mock/teamDashboardData';
...
export function Actions({ actions, selectedId, onSelect, isCompact }: ActionsProps) {
    return (
                ...
                {actions.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <p className={cn("text-xs text-text-secondary line-clamp-1 leading-relaxed opacity-80 group-hover:opacity-100 transition-all duration-500 pl-7",
