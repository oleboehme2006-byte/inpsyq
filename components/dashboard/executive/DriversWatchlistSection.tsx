...
export function DriversWatchlistSection({ drivers, watchlist }: DriversWatchlistSectionProps) {
    ...
    return (
        <div className="w-full relative h-[400px] flex gap-6">
            ...
            <div data-tutorial="executive-drivers" className={cn("h-full relative transition-all duration-700 ease-out",
            ...
            <div data-tutorial="executive-watchlist" className={cn("h-full relative transition-all duration-700 ease-out",
