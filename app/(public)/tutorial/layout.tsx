...
export default function TutorialLayout({ children }: { children: React.ReactNode }) {
    // The tutorial section requires a strict, locked viewport to allow Anime.js to hijack scroll events.
    return (
        <div className="w-full h-screen overflow-hidden bg-black text-text-primary relative selection:bg-accent-primary/30 flex flex-col">
            <nav className="w-full h-16 border-b border-white/5 flex items-center justify-between px-6 shrink-0 z-50 absolute top-0 bg-black/50 backdrop-blur-md">
