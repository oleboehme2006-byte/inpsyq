...
function main() {
    ...
    if (prodSecret) {
        ...
        allGreen = runStep('Prod Org Select Flow', 'npx tsx scripts/verification/prod.orgselect.flow.verify.ts', prodEnv) && allGreen;
        allGreen = runStep('Prod Browser Smoke', 'npx tsx scripts/verification/prod.browserlike.smoke.verify.ts', prodEnv) && allGreen;
        allGreen = runStep('Prod Admin UI Access', 'npx tsx scripts/verification/prod.admin.ui.access.verify.ts', prodEnv) && allGreen;
    } else {
